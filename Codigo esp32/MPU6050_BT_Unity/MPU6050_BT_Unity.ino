...
void loop(){
  ...
  SerialBT.print(AcX); SerialBT.print(";"); SerialBT.print(AcY); SerialBT.print(";"); SerialBT.print(AcZ); SerialBT.print(";");
  SerialBT.print(GyX); SerialBT.print(";"); SerialBT.print(GyY); SerialBT.print(";"); SerialBT.print(GyZ); SerialBT.println("");
  SerialBT.flush();
